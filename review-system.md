...
1. **图谱层**
   - Base knowledge graph and Obsidian Canvas.
   - Normal graph files stay uncolored.
   - Mistake-marked outputs may color only the direct wrong point and one parent layer.
